...
export function AddFreelancerForm({ refetch }: any) {
  ...
  async function onSubmit(data: any) {
    ...
    try {
      ...
      toast({
        variant: "default",
        title: "Freelancer added successfully!",
        description: "You have added a new Freelancer.",
      });
      setLoading(false);
      refetch();
    } catch (e: any) {
      ...
      {success ? (
        <div className="p-[100px] flex flex-col justify-center items-center">
          ...
          <p className="text-[#8A94A6] text-[14px]">
            Freelancer successfully added.
          </p>
          <br />
          <Button onClick={() => restForm()}>Add New Freelancer</Button>
        </div>
      ) : (
        <Form {...form}>
