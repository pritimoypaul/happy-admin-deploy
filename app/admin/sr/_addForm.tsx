...
export function AddSrForm({ refetch }: any) {
  ...
  async function onSubmit(data: any) {
    ...
    try {
      ...
      toast({
        variant: "default",
        title: "Sr added successfully!",
        description: "You have added a new Sr.",
      });
      setLoading(false);
      refetch();
      setSuccess(true);
    ...
    <>
      {success ? (
        <div className="p-[100px] flex flex-col justify-center items-center">
          ...
          <p className="text-[#8A94A6] text-[14px]">Sr successfully added.</p>
          <br />
