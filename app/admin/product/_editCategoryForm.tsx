...
export function EditCategoryForm({ refetchData, editData }: any) {
  ...
  async function onSubmit(data: any) {
    ...
    try {
      ...
      Object.keys(data).forEach((key) => {
        if (key === "image" && data[key] instanceof File) {
          axiosInstance
            .patch(`/categories/${editData?.id}/update-image`, formData, {
              headers: {
      ...
      await axiosInstance.patch(
        `/categories/${editData?.id}/update`,
        editedData
      );

      await axiosInstance.patch(
        `/categories/${editData?.id}/change-status`,
        statusData
      );
